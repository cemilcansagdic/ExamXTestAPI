...
namespace ExamXTestAPI.Migrations
{
    ...
    partial class ExamXContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExamXTestAPI.Models.EFModels.LoginLog", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("TriedPassword")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ExamXTestAPI.Models.EFModels.TeacherStudents", b =>
                {
            ...
            modelBuilder.Entity("ExamXTestAPI.Models.EFModels.TeacherSubject", b =>
                {
                    b.Property<int>("TeacherID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ExamXTestAPI.Models.EFModels.TeacherStudents", b =>
                {
                    b.HasOne("ExamXTestAPI.Models.EFModels.Student", "Student")
                        .WithMany("TeacherStudents")
                        .HasForeignKey("StudentID")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("ExamXTestAPI.Models.Subject", "Subject")
                        .WithMany()
                        .HasForeignKey("SubjectID");

                    b.HasOne("ExamXTestAPI.Models.EFModels.Teacher", "Teacher")
                        .WithMany("TeacherStudents")
            ...
            modelBuilder.Entity("ExamXTestAPI.Models.Question", b =>
                {
                    ...
                    b.HasOne("ExamXTestAPI.Models.Topic", "Topic")
                        .WithMany()
